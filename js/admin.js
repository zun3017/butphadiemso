...
var pinVerifyAction = "deleteStudent";
        ...
        function renderAdminTutorsList() {
            ...
            if (!adminDataGlobal.tutors || adminDataGlobal.tutors.length === 0) {
                tbody.innerHTML = "<tr><td colspan='9' style='text-align:center; color:#A6ADCE;'>Không có giáo viên nào trên hệ thống.</td></tr>";
                if (mobileContainer) {
                    mobileContainer.innerHTML = "<div style='text-align:center; color:#A6ADCE; padding: 20px; font-size: 13px;'><i class='fa-solid fa-circle-info'></i> Không có giáo viên nào trên hệ thống.</div>";
                }
                if (alertContainer) {
                        ...
                        alertHtml += `
                            <div style="background: rgba(239, 68, 68, 0.12); border: 1px solid rgba(239, 68, 68, 0.35); border-radius: 12px; padding: 15px; color: #FF8080; font-size: 13.5px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px; font-family: Inter;">
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    ...
                                    <span>⚠️ Giáo viên <b>${a.name}</b> (${a.students} HS) đến hạn đóng tiền thuê Web: <b style="color: #FFF; background: #EF4444; padding: 2px 8px; border-radius: 4px;">${a.fee.toLocaleString('vi-VN')}đ</b> (Hạn: ${a.nextBillingDate})</span>
                                </div>
        ...
        function renderAdminStudentsList() {
            ...
            adminDataGlobal.students.forEach((st, idx) => {
                ...
                mobileHtml += "    <div class='accordion-body-row'><span class='accordion-body-label'>Giáo viên</span><span class='accordion-body-val'>" + tName + "</span></div>";
        ...
        function openAdminAddTutorModal() {
            document.getElementById('adminTutorModalTitle').innerHTML = '<i class="fa-solid fa-chalkboard-user"></i> Thêm Giáo Viên Mới';
        ...
        function openAdminEditTutorModal(phone) {
            ...
            document.getElementById('adminTutorModalTitle').innerHTML = '<i class="fa-solid fa-chalkboard-user"></i> Sửa Thông Tin Giáo Viên';
        ...
        function saveAdminTutor() {
            ...
            var accountType = "Giáo viên Lớp học";
        ...
        function deleteTutorBackend() {
             ...
             showCustomConfirm("Xác nhận đưa giáo viên " + name + " vào thùng rác? Giáo viên sẽ ẩn khỏi danh sách và sẽ bị xóa vĩnh viễn sau 10 ngày.", function() {
                 google.script.run
                     .withSuccessHandler(function(res) {
                         if (res.error) {
                             showToast("Lỗi: " + res.error, "error");
