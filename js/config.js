/**
 * CONFIGURATION FILE - LỚP HỌC (THẦY GIÁO)
 * Thầy giáo thay đổi URL Google Apps Script mới và link Folder Google Drive tại đây.
 */
const APP_CONFIG = {
    ...
    // Dán URL Google Apps Script MỚI của Thầy vào đây
